...
##this has been modified and needs to be restored to its original state before use (dont worry quick changes shown be the comments)
...
img2 = tkinter.PhotoImage(file = "M:\\Encrypted drive\\System\\Viewer\\bg.png")
#original image used (.PhotoImage("frameBorder", data=))
"""
R0lGODlhQABAAPcAAHx+fMTCxKSipOTi5JSSlNTS1LSytPTy9IyKjMzKzKyq
rOzq7JyanNza3Ly6vPz6/ISChMTGxKSmpOTm5JSWlNTW1LS2tPT29IyOjMzO
zKyurOzu7JyenNze3Ly+vPz+/OkAKOUA5IEAEnwAAACuQACUAAFBAAB+AFYd
...
#"frameBorder" would originally be part of this list of elements
#style.element_create("RoundedFrame", "image",
